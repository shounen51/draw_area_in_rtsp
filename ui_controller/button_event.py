...
class btn_events():
    ...
    def save_area_btn(self):
        _area_dict = {'name': 'area1', 'areaName': '', 'area': '{"abs": [], "points": []}', 'alertType': '1', 'day': '1111111', 'hour': '0,24', 'minute': '0'}
        _name = "123"
        _H_start = '0'
        _H_end = '24'
        _sec = '1'
        ...
        _weekday = '1111111'
        _abs = []
        _1080points = normalize_points([p for p in _points], self.main.canvasHandler.get_size())
